  ...
  return (
    ...
    <div class="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
        ...
        <span class="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
            <a href="https://www.facebook.com/" target="_blank" rel="noreferrer" class="text-gray-500 hover:text-[#1877F2]">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noreferrer" class="text-gray-500 hover:text-[#E4405F]">
            ...
            <a href="https://www.twitter.com/" target="_blank" rel="noreferrer" class="text-gray-500 hover:text-[#1DA1F2]">
            ...
            <a href="https://github.com/Achziil/Balinesia" target="_blank" rel="noreferrer" class="text-gray-500 hover:text-[#181717]">
